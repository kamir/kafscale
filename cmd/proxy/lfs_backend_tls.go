...
func lfsBuildBackendTLSConfig() (*tls.Config, error) {
	enabled := lfsEnvBoolDefault("KAFSCALE_LFS_PROXY_BACKEND_TLS_ENABLED", false)
	if !enabled {
		return nil, nil
	}
	...
	insecureSkip := lfsEnvBoolDefault("KAFSCALE_LFS_PROXY_BACKEND_TLS_INSECURE_SKIP_VERIFY", false)
