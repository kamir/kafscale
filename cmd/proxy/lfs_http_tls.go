...
func lfsBuildHTTPServerTLSConfig() (*tls.Config, string, string, error) {
	enabled := lfsEnvBoolDefault("KAFSCALE_LFS_PROXY_HTTP_TLS_ENABLED", false)
	if !enabled {
		return nil, "", "", nil
	}
	...
	requireClient := lfsEnvBoolDefault("KAFSCALE_LFS_PROXY_HTTP_TLS_REQUIRE_CLIENT_CERT", false)
